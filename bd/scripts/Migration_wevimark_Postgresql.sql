...
CREATE TABLE auth_item_group (
	...
	created_at int NULL,
	updated_at int NULL,
	CONSTRAINT auth_item_group_pkey PRIMARY KEY (code)
);
...
CREATE TABLE user_visit_log (
	...
	os varchar(20) NULL,
	CONSTRAINT user_visit_log_pkey PRIMARY KEY (id)
);
...
ALTER TABLE auth_assignment ADD CONSTRAINT auth_assignment_item_name_fkey FOREIGN KEY (item_name) REFERENCES auth_item("name") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE auth_assignment ADD CONSTRAINT auth_assignment_user_id_fkey FOREIGN KEY (user_id) REFERENCES "user"(id) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- auth_item foreign keys
ALTER TABLE auth_item ADD CONSTRAINT auth_item_rule_name_fkey FOREIGN KEY (rule_name) REFERENCES auth_rule("name") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE auth_item ADD CONSTRAINT fk_auth_item_group_code FOREIGN KEY (group_code) REFERENCES auth_item_group(code) ON DELETE SET NULL ON UPDATE CASCADE;

-- auth_item_child foreign keys
ALTER TABLE auth_item_child ADD CONSTRAINT auth_item_child_child_fkey FOREIGN KEY (child) REFERENCES auth_item("name") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE auth_item_child ADD CONSTRAINT auth_item_child_parent_fkey FOREIGN KEY (parent) REFERENCES auth_item("name") ON DELETE CASCADE ON UPDATE CASCADE;

-- user_visit_log foreign keys
ALTER TABLE user_visit_log ADD CONSTRAINT user_visit_log_user_id_fkey FOREIGN KEY (user_id) REFERENCES "user"(id) ON DELETE SET NULL ON UPDATE CASCADE;
